...
class Mail(Model):
    ...
    cc = ManyToManyField(EMailEntity, related_name="mails_cc")
    bcc = ManyToManyField(EMailEntity, related_name="mails_bcc")
    in_reply_to = ForeignKey("Mail", on_delete=SET_NULL, null=True, related_name="replies")
